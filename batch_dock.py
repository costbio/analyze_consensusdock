...
Prerequisites:
    ...
    3. Run extract_alphafold_models.py to get full AlphaFold structures (RECOMMENDED)
...
Input:
    ...
    - alphafold_mapping.csv: AlphaFold mapping file (preferred, generated by extract_alphafold_models.py)
...
ALPHAFOLD_MAPPING_CSV = "alphafold_mapping.csv" # Preferred input from extract_alphafold_models.py
...
def load_best_mapping_with_pdbqt():
    ...
    if not mapping_file:
        ...
        logging.critical("Please run extract_cavities.py and extract_alphafold_models.py first.")
        sys.exit(1)
