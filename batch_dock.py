...
Prerequisites:
    ...
    3. Run download_cavityspace_structures.py to get full AlphaFold structures (RECOMMENDED)
    4. Optionally run convert_pdb_to_pdbqt.py for better performance
    5. Ensure all required paths and dependencies are correctly configured
...
Input:
    ...
    - cavityspace_mapping.csv: CavitySpace mapping file (preferred, generated by download_cavityspace_structures.py)
...
CAVITYSPACE_MAPPING_CSV = "cavityspace_mapping.csv" # Preferred input from download_cavityspace_structures.py
...
def load_best_mapping_with_pdbqt():
    ...
    mapping_files = [
        (CAVITYSPACE_MAPPING_CSV, "CavitySpace mapping"),
    ...
    if not mapping_file:
        ...
        logging.critical("Please run extract_cavities.py and download_cavityspace_structures.py first.")
        sys.exit(1)
...
if __name__ == "__main__":
    ...
    # --- Step 1: Load pre-generated UniProt mapping ---
    logging.info("Step 1: Loading pre-generated UniProt mapping.")
    try:
